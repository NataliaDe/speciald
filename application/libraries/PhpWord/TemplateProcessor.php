...
//        );
        ...
        preg_match('/\$\{' . $blockname . '}.*\$\{\/' . $blockname . '}/is', $this->tempDocumentMainPart, $matches);
...
//        }
                ...
                if (isset($matches[0])) {
            $this->tempDocumentMainPart = str_replace($matches[0], $replacement, $this->tempDocumentMainPart);
 ...
 public function deleteRow($search)
{
    ...
    public function replaceBlock_1($blockname, $replacement)
    {
        //$matches = array();
//preg_match( '/\$\{' . $blockname . '}.*\$\{\/' . $blockname . '}/is', $this->tempDocumentMainPart, $matches );
//if (isset($matches[0]))
